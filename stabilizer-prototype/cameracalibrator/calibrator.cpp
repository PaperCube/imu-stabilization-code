...
namespace calibrator {
    ...
    Mat image, img_gray;
    int BOARDSIZE[2]{12, 5};//棋盘格每行每列角点个数
    ...
    int main() {
        ...
        string image_path = "./calibration 001/*.jpg";//待处理图路径
        ...
        for (int i = 0; i < images_path.size(); i++) {
            ...
            bool found_success = findChessboardCorners(img_gray, Size(BOARDSIZE[0], BOARDSIZE[1]),
                                                       img_corner_points,
                                                       0);
//            bool found_success = findChessboardCorners(image, Size(BOARDSIZE[0], BOARDSIZE[1]),
//                                                       img_corner_points,
...
//                                                       CALIB_CB_NORMALIZE_IMAGE);
        ...
        */
        ...
        //*/
//        Mat src, dst;
//        src = imread("before-undistortion.jpg");  //读取校正前图像
...
//        waitKey(100);
//        imwrite("after-undistortion.jpg", dst);  //校正后图像
//
